// game-b Skia 뷰의 레이아웃 계산. game-a와 달리 game-b는 뷰포트가 플레이어 중심 고정
// 칸 수(가로 17×세로 13)라 보드 자체 크기는 항상 같다 — 반응형으로 조절할 건 셀 크기뿐이다
// ([[../gameA/layout.ts]]와 같은 이유로 터치 화면 폭에 맞춰 셀 크기를 계산한다).
